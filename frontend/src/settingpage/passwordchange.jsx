...
import { ChangePassword } from "../componenets";
...
const passwordchange = () => {
  ...
  const ProfileInfo = () => (
    <div className="bg-white dark:bg-gray-900 shadow-md rounded-lg p-6 mb-6">
      <p className="text-xl font-bold dark:text-white">Password Change</p>
        <p className=" text-gray-700">  This will be used to log into your account and complete high severity actions.</p>
